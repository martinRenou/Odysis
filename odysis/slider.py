...
from ipywidgets import FloatSlider as _FloatSlider
...
class FloatSlider(_FloatSlider.__base__):
    ...
    _view_name = Unicode('FixedFloatSliderView').tag(sync=True)
    _model_name = Unicode('FixedFloatSliderModel').tag(sync=True)
